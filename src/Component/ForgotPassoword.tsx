...
export default function ForgotPassword() {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-2/5 lg:w-1/2 bg-gradient-to-br from-orange-300 to-orange-400 items-center justify-center relative">
        {/* Optional logo or branding */}
        {/* You can add logo/text here if needed */}
      </div>

      {/* Right form container */}
      <div className="flex-1 flex items-center justify-center p-4 bg-gray-50">
        {/* Form box with specific width to match the yellow logo size */}
        <div className="w-full max-w-[350px] bg-white p-6 rounded-lg shadow-lg">
          ...
          {/* Send Button */}
          <button className="w-full bg-orange-500 hover:bg-orange-600 text-white px-3 py-2 rounded-lg mb-3 text-sm transition-colors">
            Send
          </button>
